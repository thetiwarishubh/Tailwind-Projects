 const bookNowButtons = document.querySelectorAll('.bookNowBtn');
        ...
        document.addEventListener('click', function (e) {
            ...
            if (viewDetailsBtn && viewDetailsBtn.textContent.includes('View Details')) {
                ...
                const prices = [...card.querySelectorAll('.price-tag')]
                    .map(p => p.textContent)
            ...
            if (e.target.closest('#package-modal') && e.target === document.querySelector('#package-modal')) {
                closeModal();
            }
        });
        ...
        document.addEventListener('click', function (e) {
            ...
            if (quickViewBtn) {
                ...
                const duration = card.querySelector('.flex.items-center.text-sm.text-gray-600.mb-3 span').textContent;
                const location = card.querySelector('.flex.items-center.text-gray-600.text-sm.mb-4').textContent.trim();
                const rating = card.querySelector('.flex.items-center.space-x-1 span:first-child').textContent;
                const badge = card.querySelector('.absolute.top-4.left-0.z-10 div')?.textContent || '';
                            ...
                            <div class="absolute bottom-4 left-4 right-4">
                                ...
                                <div class="flex items-center justify-between mt-2">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-white text-sm font-medium">${rating} (${Math.floor(Math.random() * 100) + 50} reviews)</span>
                                    </div>
        ...
        `;
                ...
                document.querySelector('.quick-book-now').addEventListener('click', function () {
                    window.location.href = 'package-booking-page.html';
                });
        ...
        document.addEventListener('click', function (e) {
            ...
            if (galleryBtn) {
                ...
                const card = galleryBtn.closest('.relative') || galleryBtn.closest('.card') || galleryBtn.closest('[class*="card"]') || galleryBtn.closest('div');
        ...
        `;
                ...
                document.querySelector('.close-gallery').addEventListener('click', closeGalleryModal);
